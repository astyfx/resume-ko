...
언 어|수 준|설 명
---|---|---
Python|**운영 경험**|현재 사용하고 있는 주언어로, Django, Flask 기반으로 한 웹프레임워크 기반 개발 경험이 있습니다.(2.7.x)
...
JavaScript|**운영 경험**|전반적인 언어와 ECMA, 자바스크립트 만의 특징을 이해하고 있으며, jQuery, AngularJS 등을 활용한 개발 경험이 있습니다.
HTML|**운영 경험**|HTML5에서 도입된 요소 및 속성에 대해 이해하고 있습니다.
CSS|**운영 경험**|Bootstrap 3, Semantic UI 등을 활용한 반응형 레이아웃 구현 경험이 있습니다. SASS를 통해 구조화된 stylesheet 코딩을 할 수 있습니다.(Less, Scss사용 경험)
...
Google App Engine|활용 가능|앱엔진 기반 서비스 개발 경험이 있으며(Stacklion[stacklion], 현재 Linux기반 서버로 이전), Cloud SQL 등 앱엔진 기반 서비스 및 API 활용 경험이 있습니다. 앱엔진을 활용한 개발에 대한 대학생 대상 강의 경험이 있습니다.(멋쟁이 사자처럼)

### 개발도구
서비스|수 준|설 명
---|---|---
Git|활용 가능|Git을 사내에 도입했으며, 협업을 해 본 경험이 있습니다.
...
---|---|---
2013|와일드파이어|'Naldo' 모바일 웹 UI 개발(JSP)
...
2014|Socialguru. Corp.|'가위바위보팡' 관리자 사이트 개발(Spring)
2014|(주)아이템매니아|'마일리지 생성기' 관리자 사이트 개발(Spring)
2014|(주)원홀딩스. THE M:ALL 쇼핑몰/카페/소셜 웹 사이트 개발(Django)
2014|와일드파이어|'Naldo' 유지보수 개발
2014|Youclip.co.kr|서버 및 프론트 엔드 개발(Django)
2014|Bitsquare.co.kr|서버 및 프론트 엔드 개발(Spring Boot)
2014|Goya Corp.|'24Hours' SNS 서비스 관리자 사이트 개발(Spring Boot)
2014|Valup|'Reshare.kr' 서버 및 프론트 엔드 개발(Spring Boot)
2014|(주)데이터스퀘어|'Buckets.kr' 서버 및 프론트 엔드 개발(Flask REST Api, AngularJS)
2014|개인 프로젝트|'Stacklion.com' 프로그래밍 Q&A 서비스(멋쟁이 사자처럼 활동 지원, 코드스터디, 라이크라이언 연계)

## 개인 평가
### 장점
- 한가지 문제를 해결하는 방법에 있어서 가장 효율적인 방법을 찾기 위해 끊임없이 노력합니다.
- 사내 문화와 업무 협업 프로세스의 중요성을 이해하고 있습니다.
- 문제가 발생했을 때, 문제임을 인식하는데에 능통하며, 문제를 다른사람과 함께 해결하기 위해 항상 논의합니다.
- 항상 공부하고 있으며, 자신이 부족하다고 생각하여, 자만하지 않으려고 노력합니다.
- 항상 신기술을 탐구하며, 신기술이 현재 제작한 프로그램에 적용 될 수 있는지 연구합니다.

### 단점
- 컴퓨터 공학 전공으로 시작한게 아니라, 컴퓨터 공학의 기본적인 부분에 대한 지식이 부족합니다. 항상 이부분을 채우기 위해 노력중이며, 기본기를 소홀히 하지 않으려고 항상 공부하고 있습니다.
- 잠을 많이 자는 편이며, 게임을 좋아하여 밤늦게 자는 경우가 많아 생활패턴 관리능력이 부족합니다.
- 개인주의 성향이 강하여, 자기주장이 강한편입니다. 의견을 나눔에 있어 충돌이 있는 편이지만 항상 다른 사람의 의견을 귀담아 듣기 위해 노력중입니다.
